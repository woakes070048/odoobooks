# -*- coding: utf-8 -*-
#
# OpenERP Book documentation build configuration file, created by
...
html_logo = './images/odoo-17-book-title.png'
...
texinfo_documents = [
    (pdf_master_doc, 'odooonlinebook', project, author, 'odooonlinebook',
        'Odoo 17 Best Practices Book', 'Miscellaneous'),
]
